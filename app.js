    ...
    function nlmPrompt(mode) {
      ...
      if (mode === "video")
        return 'Create a cinematic Video Overview of "' + t + '". Style: ' +
          ...
          "visual scene per key fact, closing with a single race-day application. " +
      ...
      return 'Create a detailed infographic of "' + t + '". Art direction: kawaii ' +
        ...
        "glossary terms as a labelled icon strip, and one 'race-day application' " +
